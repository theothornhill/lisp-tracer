...
(defstruct computations
  ...
  (object nil :type shape)
  (inside? nil :type t)
  (point (make-point :x 0.0 :y 0.0 :z 0.0) :type tuple)
  (over-point (make-point :x 0.0 :y 0.0 :z 0.0) :type tuple)
  (under-point (make-point :x 0.0 :y 0.0 :z 0.0) :type tuple)
  (eyev (make-vec :x 0.0 :y 0.0 :z 0.0) :type tuple)
  (normalv (make-vec :x 0.0 :y 0.0 :z 0.0) :type tuple)
  (reflectv (make-vec :x 0.0 :y 0.0 :z 0.0) :type tuple))
